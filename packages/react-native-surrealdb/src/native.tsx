...
import installer from "./NativeSurrealdb";
...
export * from "./generated/surrealdb_rn_core";

// Now import the bindings so we can:
// - intialize them
// - export them as namespaced objects as the default export.
import * as surrealdb_rn_core from "./generated/surrealdb_rn_core";
...
if (!initialized) {
  surrealdb_rn_core.default.initialize();
  initialized = true;
}
