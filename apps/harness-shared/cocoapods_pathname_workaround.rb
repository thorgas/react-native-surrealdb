# CocoaPods can intermittently pass a corrupted pnpm-symlink path to
# Pathname#realdirpath while generating local pod groups. Keep the normalized
# base path instead. See https://github.com/CocoaPods/CocoaPods/issues/12798.
module CocoaPodsPnpmPathnameWorkaround
...
Pod::Project.prepend(CocoaPodsPnpmPathnameWorkaround)
